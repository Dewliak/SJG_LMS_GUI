...
def make_text_printable(book_data_list: List[QrBookModel]) -> List[QrBookModel]:
    ...
    for element in book_data_list:
        element.name = (
            element.name if len(element.name) <= 39 else element.name[:36] + "..."
        )
        element.author = (
            element.author if len(element.author) <= 39 else element.author[:36] + "..."
        )
...
def generate_qr_image(
    book_data_list: List[QrBookModel], context: Context, bytes: bool = False
):
    doc = docx.Document()
...
if __name__ == "__main__":
    data = [
        QrBookModel(
            "Matematika programozasok12312312312312313123123",
            "Obadovics J gyula",
        ...
        QrBookModel(
            "Matematika programozas 239",
            "Obadovics J gyula",
            "lindasasdasdasdasdasdata",
        ),
        QrBookModel(
            "Matematika programozas 2310", "Obadovics J gyula", "lindasdasdata"
        ),
        QrBookModel(
            "Matematika programozas 2311", "Obadovics J gyula", "lindasdasdata"
        ),
        QrBookModel(
            "Matematika programozas 2312", "Obadovics J gyula", "lindasdasdata"
        ),
        QrBookModel(
            "Matematika programozas 2313", "Obadovics J gyula", "lindasdasdata"
        ),
        QrBookModel(
            "Matematika programozas 2314", "Obadovics J gyula", "lindasdasdata"
        ),
        QrBookModel(
            "Matematika programozas 2315", "Obadovics J gyula", "lindasdasdata"
        ),
    ]

    data2 = [
        QrBookModel(name="ASD", author="1", link="http://127.0.0.1:5000/?=1"),
        QrBookModel(
            name="test", author="test", link="http://127.0.0.1:5000/?=562977095734"
        ),
    ]
